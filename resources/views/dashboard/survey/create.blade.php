                        ...
                        <form action="{{ route('survey.store') }}" method="POST" class="add-new-survey pt-0">
                            ...
                            <div class="mb-6 mt-6 form-control-validation">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="survey-name" placeholder="Contoh: Survei Kepuasan Pelayanan Umum" name="name"
                            ...
                            <div class="mb-6 form-control-validation">
                                ...
                                <textarea id="survey-caption" class="form-control @error('caption') is-invalid @enderror" name="caption" rows="5"
                                    required
                                    placeholder="Halo Sahabat Pengayoman DIY 👋
                            ...
                            <div class="mb-6">
                                ...
                                <select id="survey-active" class="form-select @error('is_active') is-invalid @enderror"
                                    name="is_active" required>
                                    <option value="1" {{ old('is_active') == 1 ? 'selected' : '' }}>Aktif (Link ini
                                        akan digunakan)</option>
